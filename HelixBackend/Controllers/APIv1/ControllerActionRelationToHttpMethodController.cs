...
namespace HelixBackend.Controllers.APIv1
{
    ...
    public class ControllerActionRelationToHttpMethodController : AbstractController<ControllerActionRelationToHttpMethodModel, ControllerActionRelationToHttpMethodModule>
    {
