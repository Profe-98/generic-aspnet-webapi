...
namespace HelixBackend.Controllers.APIv1
{
    ...
    public class OdbcDriverVersionRelationToConnectionTypeController : AbstractController<OdbcDriverVersionRelationToConnectionTypeModel, OdbcDriverVersionRelationConnectionTypeModule>
    {
