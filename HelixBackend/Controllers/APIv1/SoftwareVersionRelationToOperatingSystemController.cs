...
namespace HelixBackend.Controllers.APIv1
{
    ...
    public class SoftwareVersionRelationToOperatingSystemController : AbstractController<SoftwareVersionRelationToOperatingSystemModel, SoftwareVersionRelationOperatingSystemModule>
    {
