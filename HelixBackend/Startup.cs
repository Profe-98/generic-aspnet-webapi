...
namespace HelixBackend
{
    public class Startup : IWebApiStartup
    {
        public static string[] DatabaseEntityNamespaces { get; } = new string[] { "WebApiFunction.Application.Model.Database.MySql.Helix", "WebApiFunction.Application.Model.Database.MySql.Entity" };
        ...
        public Startup(IConfiguration configuration, Microsoft.AspNetCore.Hosting.IWebHostEnvironment env)
        {
            ...
            initialDatabaseConfigurationModel.User = "helix";
