...
namespace WebApiApplicationService.Models.InternalModels
{
    ...
    public class HealthCheckResponseObject
    {
        ...
        public void RefreshStatistics()
        {
            ...
            this.Status = HealthyCountPercent == 100.0? HealthStatus.Healthy:HealthStatus.Unhealthy;
        }
    }
    [Serializable]
    public class HealthCheckNodeResponseObject
    {
        ...
        {
            this.Status = healthReportEntry.Status;
            this.Description = healthReportEntry.Description;
            this.Data = healthReportEntry.Data;
            this.Duration = healthReportEntry.Duration;
        }
    }
}
