...
namespace WebApiApplicationService.Handler
{
    public class NetworkUtilityHandler
    {
        ...
        public class NetworkCardProperties
        {
            ...
            public Int64 DeviceRangev4Count
            {
                get
                {
                    var val = Math.Pow(2.0, (double)DeviceRangev4Bits).ToString();
                    Int64 result = Int64.Parse(val);
                    return result-2;
                }
            }
        ...
        public async void Test()
        {
            ...
            var iptest = new NetworkUtilityHandler.NetworkCardProperties { Ip = IPAddress.Parse("8.8.8.8"), Mask = IPAddress.Parse("255.255.255.0") };
