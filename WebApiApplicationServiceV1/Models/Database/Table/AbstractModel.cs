...
namespace WebApiApplicationService.Models
{
    public class AbstractModel : IDisposable
    {
        ...
        public Func<string, string> fGenerateTableNameFromNetClassName = new Func<string, string>((x) => {
            ...
            {
                System.Text.StringBuilder stringBuilder = new System.Text.StringBuilder(tabName);
        ...
        public Guid GeneralClassIdentifier
        {
            get
            {
                ...
                {
                    string currentClassName = this.GetType().Name.ToLower();
        ...
        public bool OnlyFieldValuesSetted
        {
            get
            {
                ...
                List<object> thisCurrentValues = this.KeyValues;
        ...
        public string DatabaseTable
        {
            get
            {
                ...
                {
                    _databaseName = fGenerateTableNameFromNetClassName(this.GetType().Name);
                }
        ...
        {
            string table = model == null?this.DatabaseTable:model.DatabaseTable;
        ...
        [DatabaseColumnPropertyAttribute("creation_datetime", MySql.Data.MySqlClient.MySqlDbType.DateTime)]
        virtual public DateTime CreationDateTime { get; set; }

        [JsonPropertyName("active")]
        [DatabaseColumnPropertyAttribute("active", MySql.Data.MySqlClient.MySqlDbType.Bit)]
        virtual public bool Active { get; set; } = false;

        [DataType(DataType.DateTime, ErrorMessage = DataValidationMessageStruct.WrongDateTimeFormatMsg)]
        [JsonPropertyName("activation_datetime")]
        [DatabaseColumnPropertyAttribute("activation_datetime", MySql.Data.MySqlClient.MySqlDbType.DateTime)]
        virtual public DateTime ActivationDateTime { get; set; }

        [JsonPropertyName("deleted")]
        [DatabaseColumnPropertyAttribute("deleted", MySql.Data.MySqlClient.MySqlDbType.Bit, true)]
        virtual public bool Deleted { get; set; }

        [DataType(DataType.DateTime, ErrorMessage = DataValidationMessageStruct.WrongDateTimeFormatMsg)]
        [JsonPropertyName("deletion_datetime")]
        [DatabaseColumnPropertyAttribute("deletion_datetime", MySql.Data.MySqlClient.MySqlDbType.DateTime)]
        virtual public DateTime DeletionDateTime { get; set; }

        [DataType(DataType.DateTime, ErrorMessage = DataValidationMessageStruct.WrongDateTimeFormatMsg)]
        [JsonPropertyName("changed_datetime")]
        [DatabaseColumnPropertyAttribute("changed_datetime", MySql.Data.MySqlClient.MySqlDbType.DateTime)]
        ...
        {
            return "/" + actionUri.Replace(BackendAPIDefinitionsProperties.ActionParameterIdWildcard, this.Uuid.ToString()).Replace(BackendAPIDefinitionsProperties.ActionParameterFileOptWildcard, fileName ?? "").ToLower();
        }
        ...
        {
            List<MemberInfo> members = this.GetType().GetMember(classMemberName).ToList();
        ...
        {
            List<PropertyInfo> members = this.GetType().GetProperties().ToList();
        ...
        public List<DatabaseColumnPropertyAttribute> GetDatabaseColumns()
        {
            ...
            return GetDatabaseColumns(this.GetType());
        }
        /// <summary>
        ...
        public QueryObject GenerateQuery(SQLDefinitionProperties.SQL_STATEMENT_ART typeOfStatement, object customWhereClauseObject = null, object classInstance = null)
        {
            ...
            if (defaultPropertiesWithValues.Count == thisPropertiesWithValues.Count)
            {
                ...
                string table = this.DatabaseTable;
