...
namespace WebApiApplicationService.InternalModels
{
    public class ClassModelWrapper : AbstractModel
    {
        ...
        public List<KeyValuePair<string,string>> LinkTableMembers
        {
            get
            {
                var findVals = Relations.Select(x => {
                    ...
                    if(x.EntityOne == this.ClassModel.TableName)
                    {
                ...
                return this.ClassModel.TableName.ToLower().Contains(SQLDefinitionProperties.TableNameRelationTableIdentifier)?findVals:null;
            }
        }
        ...
        public bool IsKeyColumn(DatabaseColumnPropertyAttribute databaseColumnPropertyAttribute)
        {
            ...
            return (this.AllKeys.Find(x => x == col) != null);
        }
        public override string ToString()
        {
            return this.ClassModel.TableName;
        }
