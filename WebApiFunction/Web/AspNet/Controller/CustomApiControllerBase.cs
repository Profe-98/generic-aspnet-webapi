...
namespace WebApiFunction.Web.AspNet.Controller
{
        ...
        where T : AbstractModel
    {
        ...
        [NonAction]
        protected async Task<QueryResponseData<object>> SqlOp(AbstractModel abstractModelFieldValues, AbstractModel abstractModelWhereClause, Type type, SQLDefinitionProperties.SQL_STATEMENT_ART statementType)
        {
