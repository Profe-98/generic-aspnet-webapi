...
namespace WebApiFunction.Application.Model.Database.MySql.Entity
{
    ...
    public class OdbcDriverModel : AbstractModel
    {
        ...
        [DatabaseColumnPropertyAttribute("description", MySqlDbType.String)]
        public string DriverDescription { get; set; }

        [Required(ErrorMessage = DataValidationMessageStruct.MemberIsRequiredButNotSetMsg)]
        [JsonPropertyName("icon_exist_flag")]
        [DatabaseColumnPropertyAttribute("icon_exist_flag", MySqlDbType.Bit)]
        public bool IconExists { get; set; }

        [Required(ErrorMessage = DataValidationMessageStruct.MemberIsRequiredButNotSetMsg)]
        [JsonPropertyName("banner_exist_flag")]
        [DatabaseColumnPropertyAttribute("banner_exist_flag", MySqlDbType.Bit)]
