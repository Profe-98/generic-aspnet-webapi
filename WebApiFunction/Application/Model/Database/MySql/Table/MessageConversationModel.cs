...
namespace WebApiFunction.Application.Model.Database.MySql.Table
{
    ...
    public class MessageConversationModel : AbstractModel
    {
        ...
        [DatabaseColumnPropertyAttribute("message_conversation_state_type_uuid", MySqlDbType.String)]
        ...
        [DatabaseColumnPropertyAttribute("display_conf_identifier", MySqlDbType.String)]
        ...
        [DatabaseColumnPropertyAttribute("scoped_conf_count", MySqlDbType.Int32)]
        ...
        [DatabaseColumnPropertyAttribute("message_queue_uuid", MySqlDbType.String)]
