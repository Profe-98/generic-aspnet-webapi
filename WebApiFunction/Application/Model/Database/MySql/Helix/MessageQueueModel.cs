...
namespace WebApiFunction.Application.Model.Database.MySQL.Helix
{
    ...
    public class MessageQueueModel : AbstractModel
    {
        ...
        [DatabaseColumnProperty("system_message_user_uuid", MySqlDbType.String)]
        ...
        [DatabaseColumnProperty("initial_message", MySqlDbType.String)]
        ...
        [DatabaseColumnProperty("inbox_folder", MySqlDbType.String)]
        ...
        [DatabaseColumnProperty("procedded_folder", MySqlDbType.String)]
        ...
        [DatabaseColumnProperty("delete_mails_after_processing", MySqlDbType.Bit)]
        ...
        [DatabaseColumnProperty("is_junk", MySqlDbType.Bit)]
        ...
        [DatabaseColumnProperty("max_attachment_file_size", MySqlDbType.Int32)]
        ...
        [DatabaseColumnProperty("allowed_attachment_file_extensions", MySqlDbType.JSON)]
        ...
        [DatabaseColumnProperty("attachment_av_check", MySqlDbType.Bit)]
