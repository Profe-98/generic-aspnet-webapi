...
namespace WebApiFunction.Application.Controller.Modules.Helix
{
    public class OperatingSystemModule : AbstractBackendModule<OperatingSystemModel>
    {
        ...
        #endregion
        #region Ctor & Dtor
        public OperatingSystemModule(ISingletonDatabaseHandler databaseHandler, ICachingHandler cache, IMysqlDapperContext mysqlDapperContext) : base(databaseHandler, cache, mysqlDapperContext)
        {
