...
namespace WebApiFunction.Application.Controller.Modules.Helix
{
    public class OdbcDriverVersionFileModule : AbstractBackendModule<OdbcDriverVersionFileModel>
    {
        ...
        #endregion
        #region Ctor & Dtor
        public OdbcDriverVersionFileModule(ISingletonDatabaseHandler databaseHandler, ICachingHandler cache, IMysqlDapperContext mysqlDapperContext) : base(databaseHandler, cache, mysqlDapperContext)
        {
