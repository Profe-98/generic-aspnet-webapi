...
namespace WebApiFunction.Application.Controller.Modules.Helix
{
    public class ConnectionstringValuesModule : AbstractBackendModule<ConnectionstringValuesModel>
    {
        ...
        #endregion
        #region Ctor & Dtor
        public ConnectionstringValuesModule(ISingletonDatabaseHandler databaseHandler, ICachingHandler cache, IMysqlDapperContext mysqlDapperContext) : base(databaseHandler, cache, mysqlDapperContext)
        {
