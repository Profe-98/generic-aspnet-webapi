...
namespace WebApiFunction.Application.Controller.Modules.Helix
{
    public class SoftwareModule : AbstractBackendModule<SoftwareModel>
    {
        ...
        #endregion
        #region Ctor & Dtor
        public SoftwareModule(ISingletonDatabaseHandler databaseHandler, ICachingHandler cache, IMysqlDapperContext mysqlDapperContext) : base(databaseHandler, cache, mysqlDapperContext)
        {
