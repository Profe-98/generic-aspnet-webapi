...
namespace WebApiFunction.Application.Controller.Modules.Helix
{
    public class MessageConversationModule : AbstractBackendModule<MessageConversationModel>
    {
        ...
        #endregion
        #region Ctor & Dtor
        public MessageConversationModule(ISingletonDatabaseHandler databaseHandler, ICachingHandler cache, IMysqlDapperContext mysqlDapperContext) : base(databaseHandler, cache, mysqlDapperContext)
        {
