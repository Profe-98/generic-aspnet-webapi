...
namespace WebApiFunction.Application.Controller.Modules.Helix
{
    public class ConnectionTypeModule : AbstractBackendModule<ConnectionTypeModel>
    {
        ...
        #endregion
        #region Ctor & Dtor
        public ConnectionTypeModule(ISingletonDatabaseHandler databaseHandler, ICachingHandler cache, IMysqlDapperContext mysqlDapperContext) : base(databaseHandler, cache, mysqlDapperContext)
        {
