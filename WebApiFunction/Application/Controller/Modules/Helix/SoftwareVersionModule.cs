...
namespace WebApiFunction.Application.Controller.Modules.Helix
{
    public class SoftwareVersionModule : AbstractBackendModule<SoftwareVersionModel>
    {
        ...
        #endregion
        #region Ctor & Dtor
        public SoftwareVersionModule(ISingletonDatabaseHandler databaseHandler, ICachingHandler cache, IMysqlDapperContext mysqlDapperContext) : base(databaseHandler, cache, mysqlDapperContext)
        {
