...
namespace WebApiFunction.Application.Controller.Modules.Helix
{
    public class OdbcDriverModule : AbstractBackendModule<OdbcDriverModel>
    {
        ...
        #endregion
        #region Ctor & Dtor
        public OdbcDriverModule(ISingletonDatabaseHandler databaseHandler, ICachingHandler cache, IMysqlDapperContext mysqlDapperContext) : base(databaseHandler, cache, mysqlDapperContext)
        {
