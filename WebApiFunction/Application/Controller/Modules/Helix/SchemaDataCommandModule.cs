...
namespace WebApiFunction.Application.Controller.Modules.Helix
{
    public class SchemaDataCommandModule : AbstractBackendModule<SchemaDataCommandModel>
    {
        ...
        #endregion
        #region Ctor & Dtor
        public SchemaDataCommandModule(ISingletonDatabaseHandler databaseHandler, ICachingHandler cache, IMysqlDapperContext mysqlDapperContext) : base(databaseHandler, cache, mysqlDapperContext)
        {
