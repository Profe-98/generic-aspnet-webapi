...
namespace WebApiFunction.Application.Controller.Modules.Helix
{
    public class OdbcDriverVersionModule : AbstractBackendModule<OdbcDriverVersionModel>
    {
        ...
        #endregion
        #region Ctor & Dtor
        public OdbcDriverVersionModule(ISingletonDatabaseHandler databaseHandler, ICachingHandler cache, IMysqlDapperContext mysqlDapperContext) : base(databaseHandler, cache, mysqlDapperContext)
        {
