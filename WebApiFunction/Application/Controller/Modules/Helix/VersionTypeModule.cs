...
namespace WebApiFunction.Application.Controller.Modules.Helix
{
    public class VersionTypeModule : AbstractBackendModule<VersionTypeModel>
    {
        ...
        #endregion
        #region Ctor & Dtor
        public VersionTypeModule(IScopedDatabaseHandler databaseHandler, ICachingHandler cache, MysqlDapperContext mysqlDapperContext) : base(databaseHandler, cache, mysqlDapperContext)
        {
