...
namespace WebApiFunction.Application.Controller.Modules
{
    public class OdbcDriverVersionRelationConnectionStringModule : CustomBackendModule<OdbcDriverVersionRelationToConnectionstringValuesModel>
    {
        ...
        #endregion
        #region Ctor & Dtor
        public OdbcDriverVersionRelationConnectionStringModule(IScopedDatabaseHandler databaseHandler, ICachingHandler cache,WebApiFunction.Application.Model.Database.MySql.Dapper.Context.MysqlDapperContext mysqlDapperContext) : base(databaseHandler, cache, mysqlDapperContext)
        {
