...
namespace WebApiFunction.Application.Controller.Modules
{
    public class HttpMethodModule : AbstractBackendModule<HttpMethodModel>
    {
        ...
        #endregion
        #region Ctor & Dtor
        public HttpMethodModule(ISingletonDatabaseHandler databaseHandler, ICachingHandler cache, IMysqlDapperContext mysqlDapperContext) : base(databaseHandler, cache, mysqlDapperContext)
        {
