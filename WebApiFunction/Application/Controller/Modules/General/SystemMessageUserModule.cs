...
namespace WebApiFunction.Application.Controller.Modules
{
    public class SystemMessageUserModule : AbstractBackendModule<SystemMessageUserModel>
    {
        ...
        #endregion
        #region Ctor & Dtor
        public SystemMessageUserModule(ISingletonDatabaseHandler databaseHandler, ICachingHandler cache, IMysqlDapperContext mysqlDapperContext) : base(databaseHandler, cache, mysqlDapperContext)
        {
