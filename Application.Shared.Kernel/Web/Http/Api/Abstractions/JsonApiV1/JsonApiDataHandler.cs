    ...
    public class JsonApiDataHandler : IJsonApiDataHandler
    {
            ...
            where T : AbstractModel
        {
            ...
            if (rel.EntityOne == datam.DatabaseTable)
            {
                ...
                type = rel.EntityTwo;
                classModelWrapperRel = MySqlDefinitionProperties.BackendTablesEx[rel.EntityTwo];
                classModelWrapperCurrentNode = MySqlDefinitionProperties.BackendTablesEx[rel.EntityOne];
            ...
            {
                type = rel.EntityOne;
                classModelWrapperCurrentNode = MySqlDefinitionProperties.BackendTablesEx[rel.EntityTwo];
                classModelWrapperRel = MySqlDefinitionProperties.BackendTablesEx[rel.EntityOne];
        ...
        public async Task<List<object>> GetorSetCacheData(object model)
        {
            ...
            var query = ((AbstractModel)model).GenerateQuery(MySqlDefinitionProperties.SQL_STATEMENT_ART.SELECT, model);
        ...
        public List<T> GetConvertedFromApiData<T>(string area, List<T> data) where T : ApiDataModel
        {
            ...
            if (Utils.IsList<T>(data))
            {
                ...
                {
                    Type t = MySqlDefinitionProperties.GetBackendTableByTypeStr(apiData.Type);
                    if (t != null)
                    {
