...
{
    [Serializable]
    public class UserModel : Application.Model.Database.MySQL.Schema.ApiGateway.Table.UserModel
    {
        #region Private
        ...
        public UserModel(Application.Model.Database.MySQL.Schema.ApiGateway.Table.UserModel userModel)
        {
            if (userModel == null)
                return;
            User = userModel.User;
