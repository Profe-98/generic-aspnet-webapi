...
namespace Application.Shared.Kernel.Application.Model.DataTransferObject.Attribute
{
    [AttributeUsage(AttributeTargets.Class | AttributeTargets.Property, Inherited = true, AllowMultiple = false)]
    internal class SensitiveDataAttribute : System.Attribute
    {
                ...
                if (subValue != null)
                {
                    if (subValue is IList)
                    {
                        ...
                        for (int i = 0; i < data.Count(); i++)
                        {
                            ...
                            var resp = data[i].SetSensitivePropertiesToDefault(claims);
                    ...
                    else
                    {
                        ...
                        var resp = subValue.SetSensitivePropertiesToDefault(claims);
