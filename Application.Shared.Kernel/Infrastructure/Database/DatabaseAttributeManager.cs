...
namespace Application.Shared.Kernel.Infrastructure.Database
{
    public class DatabaseAttributeManager
    {
        ...
        #endregion Ctor & Dtor
        #region Methods
        public void FetchObjectToCommandParameters<T>(T objectInstance, ref MySqlCommand command, MySqlDefinitionProperties.SQL_STATEMENT_ART statementArt)
        {
            try
            {
                if (objectInstance != null)
                {
                    ...
                    foreach (PropertyInfo propertyInfo in propertyInfos)
                    {
                        ...
                        if (customAttributeData != null && customAttributeData.Count != 0)
                        {
                            ...
                            DatabaseColumnPropertyAttribute databaseColumn = customAttributeData[0];
                        ...
                        else
                        {
                            ...
                            mySqlDbType = MySqlDefinitionProperties.GetMySqlDbTypeFromNetType(propertyInfo.PropertyType);
                        }
