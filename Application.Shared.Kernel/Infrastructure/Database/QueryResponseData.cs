...
namespace Application.Shared.Kernel.Infrastructure.Database
{
    ...
    public class QueryResponseData : IDisposable
    {
        ...
        public class SchemaNode
        {
            ...
            private MySqlDefinitionProperties.SQL_FROM_CLAUSES _fromClause;
            #endregion
            #region Public
            ...
            public MySqlDefinitionProperties.SQL_FROM_CLAUSES FromClause
            {
                get
                {
                    return _fromClause;
        ...
        public List<SchemaNode> StatementIncludedDbNodes
        {
            get
            {
                ...
                MySqlDefinitionProperties.SQL_STATEMENT_ART type = StatementArt;
                string statementTmp = StatementWithoutSpecialChars;
                if (statementTmp != null && type != MySqlDefinitionProperties.SQL_STATEMENT_ART.NONE)
                {
                    ...
                    {
                        if (type == MySqlDefinitionProperties.SQL_STATEMENT_ART.INSERT)
                        {
                            splitList.RemoveRange(0, 2);//INSERT INTO aus Idx 0&1 entfernen
                        }
                        else if (type == MySqlDefinitionProperties.SQL_STATEMENT_ART.UPDATE)
                        {
                            splitList.RemoveAt(0);//UPDATE aus Idx 0 entfernen
                        }

                        if (type == MySqlDefinitionProperties.SQL_STATEMENT_ART.INSERT || type == MySqlDefinitionProperties.SQL_STATEMENT_ART.UPDATE)
                        {

                            SchemaNode node = new SchemaNode();
                            node.FromClause = MySqlDefinitionProperties.SQL_FROM_CLAUSES.INVALID;
                        ...
                        for (int i = 0; i < splitList.Count; i++)
                        {
                            ...
                            if (!string.IsNullOrEmpty(value))
                            {
                                ...
                                MySqlDefinitionProperties.SQL_FROM_CLAUSES fromClause = MySqlDefinitionProperties.GetSqlFromClause(value);
                                if (fromClause != MySqlDefinitionProperties.SQL_FROM_CLAUSES.INVALID)//next value must be an table/view/functionname/procedurename/schemaname etc. 
                                {
                                    int nextIndex = i + 1;
                                    if (nextIndex < splitList.Count)
                                    {
                                        ...
                                        // ---> SELECT c.id,c.odbc_driver_version_id,c.sqlQuery FROM api_gateway.odbc_driver_version_schema_data_command as c inner join api_gateway.schema_data_command as s on(s.id = c.id) WHERE c.odbc_driver_version_id = 1;
                                        // its extract the schema from tablename in this example: SCHEMA.TABLE --> api_gateway.odbc_driver_version_schema_data_command, split by dot (.)
        ...
        public MySqlDefinitionProperties.SQL_STATEMENT_ART StatementArt
        {
            get
            {
        ...
        public bool HasStatementJoins
        {
            get
            {
                ...
                x.FromClause == MySqlDefinitionProperties.SQL_FROM_CLAUSES.JOIN ||
                x.FromClause == MySqlDefinitionProperties.SQL_FROM_CLAUSES.LEFT_INNER_JOIN ||
                x.FromClause == MySqlDefinitionProperties.SQL_FROM_CLAUSES.LEFT_JOIN ||
                x.FromClause == MySqlDefinitionProperties.SQL_FROM_CLAUSES.LEFT_OUTER_JOIN ||
                x.FromClause == MySqlDefinitionProperties.SQL_FROM_CLAUSES.RIGHT_INNER_JOIN ||
                x.FromClause == MySqlDefinitionProperties.SQL_FROM_CLAUSES.RIGHT_JOIN ||
                x.FromClause == MySqlDefinitionProperties.SQL_FROM_CLAUSES.RIGHT_OUTER_JOIN
                );
        ...
        public SchemaNode PrimaryNode
        {
            get
            {
                ...
                if (stmnArt == MySqlDefinitionProperties.SQL_STATEMENT_ART.SELECT || stmnArt == MySqlDefinitionProperties.SQL_STATEMENT_ART.DELETE)
                {
                    SchemaNode lastWhere = tmp.FindLast(x => x.FromClause == MySqlDefinitionProperties.SQL_FROM_CLAUSES.WHERE);
                    ...
                    if (indexWhere != -1)//erstes From vor Where Clause
                    {
                        ...
                        {
                            if (tmp[i].FromClause == MySqlDefinitionProperties.SQL_FROM_CLAUSES.FROM)
                            {
                    ...
                    {
                        responseValues = tmp.FindLast(x => x.FromClause == MySqlDefinitionProperties.SQL_FROM_CLAUSES.FROM);
                    }
                }
                else if (stmnArt == MySqlDefinitionProperties.SQL_STATEMENT_ART.INSERT || stmnArt == MySqlDefinitionProperties.SQL_STATEMENT_ART.UPDATE)
                {
                    if (tmp.Count != 0)
        ...
        public static MySqlDefinitionProperties.SQL_STATEMENT_ART GetStatementArt(string statement)
        {
            if (string.IsNullOrEmpty(statement))
            {
                return MySqlDefinitionProperties.SQL_STATEMENT_ART.NONE;
            }
            Array statementArtValues = Enum.GetValues(typeof(MySqlDefinitionProperties.SQL_STATEMENT_ART));
            foreach (int val in statementArtValues)
            {
                MySqlDefinitionProperties.SQL_STATEMENT_ART tmp = (MySqlDefinitionProperties.SQL_STATEMENT_ART)val;
