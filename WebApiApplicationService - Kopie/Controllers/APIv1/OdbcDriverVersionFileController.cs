...
namespace WebApiApplicationService.Controllers.APIv1
{
    ...
    public class OdbcDriverVersionFileController : CustomApiControllerBase<OdbcDriverVersionFileModel, OdbcDriverVersionFileModule, DriverVersionUploadFormData>
    {
